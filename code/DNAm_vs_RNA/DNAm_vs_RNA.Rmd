...
ggsave(filename = file.path(dir.plot, "ADNI_DNAm_RNA_vs_mICC_promoter_region_boxplot.pdf"),
       width = 8, height = 5)
```

```{r}
summ.table(results.promoter.analysis.with.reliable, Group = "sig", type = "modified_ICC")
```
...
ggsave(filename = file.path(dir.plot, "ADNI_DNAm_RNA_vs_mICC_distal_region_boxplot.pdf"),
       width = 8, height = 5)
```

```{r}
summ.table(results.distal.analysis.with.reliable, Group = "sig", type = "modified_ICC")
```

...
To study the ICCs for probes in our EPIC-EPIC comparison, we compared the distributions of the ICCs in our EPIC-EPIC comparison with studies from Sugden et al. (2020) [4], Logue et al. (2017) [5], and Bose et al. (2014) [6] and several characteristics of probes (i.e. probe type). Furthermore, we evaluated the ICC distribution with our previous DNAm-AD association studies [7-8], DNAm-to-mRNA correlations, and blood-brain DNAm correlations.
